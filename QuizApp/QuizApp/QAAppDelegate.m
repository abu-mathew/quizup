...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.viewController = [[QAHomeScreenViewController alloc]init];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSString *storePath = [[self applicationDocumentsDirectory] stringByAppendingPathComponent: @"QuizApp.sqlite"];
    /*
     Set up the store.
    ...
    if (![fileManager fileExistsAtPath:storePath]) {
        NSString *defaultStorePath = [[NSBundle mainBundle] pathForResource:@"QuizApp" ofType:@"sqlite"];
        if (defaultStorePath) {
...
-(void) copyFilesToDocumentsDirectory {
    ...
    NSString *documentDBFolderPath = [documentsDirectory stringByAppendingPathComponent:@"QuizApp.sqlite"];
    ...
    if (success){
        ...
        resourceDBFolderPath = [[NSBundle mainBundle] pathForResource:@"QuizApp" ofType:@"sqlite"];
